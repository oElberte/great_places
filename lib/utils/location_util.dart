...
// I deleted the API used in this application for security purposes. I used the Google Cloud Platform with Geocoding, Maps SDK for Android, Maps SDK for iOS, Maps Static API and Places API this app.
const googleApiKey = 'INSERT API HERE';
